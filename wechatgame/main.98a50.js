(function () {
    ...
    function boot () {
        ...
        {
            var bundledScript = settings.debug ? 'src/project.dev.ec3af.js' : 'src/project.js';
            if (jsList) {
    ...
    if (true) {
        require(window._CCSettings.debug ? 'cocos2d-js.a6a95.js' : 'cocos2d-js-min.js');
        var prevPipe = cc.loader.md5Pipe || cc.loader.assetLoader;
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.a6a95.js' : 'cocos2d-js-min.js';
